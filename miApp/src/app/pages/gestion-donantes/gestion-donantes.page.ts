...
import { Empresa, Suscripcion } from 'src/app/models/empresa.model';
import { EmpresaService } from 'src/app/services/empresaService/empresa.service';

@Component({
  selector: 'app-gestion-donantes',
  templateUrl: './gestion-donantes.page.html',
  styleUrls: ['./gestion-donantes.page.scss'],
  standalone: false
})
export class GestionDonantesPage implements OnInit {
